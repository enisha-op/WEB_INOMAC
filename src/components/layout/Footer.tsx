...
export const Footer = () => {
  ...
  return (
    /* Mantenemos bg-black fijo como pediste */
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-[11px] font-bold tracking-[0.1em] uppercase">
              <li><a href="#catalogo" className="text-white/70 hover:text-primary transition-colors">TH7 530HP LNG</a></li>
              <li><a href="#catalogo" className="text-white/70 hover:text-primary transition-colors">TH7 480HP LNG</a></li>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-[11px] font-bold tracking-[0.1em] uppercase">
              <li><a href="#inicio" className="text-white/70 hover:text-primary transition-colors">Inicio</a></li>
              <li><a href="#financiamiento" className="text-white/70 hover:text-primary transition-colors">Finanzas</a></li>
              <li><a href="#contacto" className="text-white/70 hover:text-primary transition-colors">Asesoría</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 flex flex-col md:items-end">
            ...
            <div className="flex gap-8 mb-12">
              <a href="#" className="text-white/60 hover:text-primary transition-all hover:scale-110"><Facebook size={22} strokeWidth={1.5} /></a>
              <a href="#" className="text-white/60 hover:text-primary transition-all hover:scale-110"><Instagram size={22} strokeWidth={1.5} /></a>
              <a href="#" className="text-white/60 hover:text-primary transition-all hover:scale-110"><Linkedin size={22} strokeWidth={1.5} /></a>
            </div>
